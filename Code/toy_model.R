...
png("toy-posterior.png", width = 10, height = 4, units = "in", res = 500)
par(mar = c(1.5,1.5,1.5,1.5), mgp = c(1.8, 0.5, 0))
par(mfrow = c(2,4))
plot(density(sample_mgig_mrc),xlim = c(-2.5,-0.5),xlab = "",main = "MGIG-certain")
abline(v = Omega[1,2])
plot(density(sample_mgig_mrc_noexp),xlim = c(-2.5,-0.5),xlab = "",main = "MGIG-certain-noexp")
abline(v = Omega[1,2])
plot(density(sample_mgig_mru),xlim = c(-2.5,-0.5),xlab = "",main = "MGIG-uncertain")
abline(v = Omega[1,2])
plot(density(sample_mgig_mru_noexp),xlim = c(-2.5,-0.5),xlab = "",main = "MGIG-uncertain-noexp")
abline(v = Omega[1,2])

plot(density(sample_wishart_wrc),xlim = c(-2.5,-0.5),xlab = "",main = "Wishart-certain")
abline(v = Omega[1,2])
plot(density(sample_wishart_wrc_noexp),xlim = c(-2.5,-0.5),xlab = "",main = "Wishart-certain-noexp")
abline(v = Omega[1,2])
plot(density(sample_wishart_wru),xlim = c(-2.5,-0.5),xlab = "",main = "Wishart-uncertain")
abline(v = Omega[1,2])
plot(density(sample_wishart_wru_noexp),xlim = c(-2.5,-0.5),xlab = "",main = "Wishart-uncertain")
abline(v = Omega[1,2])
dev.off()
