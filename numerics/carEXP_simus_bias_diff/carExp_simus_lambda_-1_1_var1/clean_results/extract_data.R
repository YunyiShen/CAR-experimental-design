...
make_base_name_list <- function(bname){
  base_name_wc <- sub( "10.0", " 0.1", sub("MGIG",
                      "Wishart", bname) )
  base_name_wu <- sub(" 0.1","10.0", base_name_wc)
  
  base_name_mc <- sub("Wishart","MGIG",base_name_wc)
  
  base_name_mu <- sub("Wishart","MGIG",base_name_wu)
  
  basename_pat <- basename_list <- c(base_name_wu, base_name_wc, base_name_mu, base_name_mc)
