...
##### set up what we want ####
cert_level <- list(cert = " 0.1", uncert = "10.0")
...
prior_names <- c("MGIG-midcert", "MGIG-miduncert", "Wishart-midcert", "Wishart-miduncert")
...
ylabb <- paste( ifelse(stein, "log Stein's loss change\n to null design", 
...
ggsave(fig_file,
       width = 6.5, height = 3.5, scale = 0.975)  
